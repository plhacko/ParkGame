...
public class UIUnit : Selectable, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void Initialize(SoldierBase unit, Action removeAction, Action onDeath)
    {
        this.unit = unit;
        ...
        if (unitIcons.Count == Enum.GetNames(typeof(SoldierBase.UnitType)).Length)
        {
            var type = unit.Type;
